...
class MySQLTest extends TestCase
{
    ...
    {
        $table = new MetaTable($table ? $table : self::$mainTable);
    ...
    public function testCreateTable()
    {
        $this->getDBManager()
                ...
                ->setColumn('cDouble', 'DOUBLE')
                ->setColumn('cDoublePreceision', ['DOUBLE' => [10, 2]])
                ->setPrimaryKey('id')
                ->execute();
        ...
        $this->assertEquals('varchar', $columns['cVChar']->dataType);
    ...
    public function testAlterTable()
    {
        $this->getDBManager()
                ...
                ->setColumn(['cDouble' => 'cDoubleChanged'], 'DOUBLE')
        ...
        $this->assertEquals('double', $columns['cDoubleChanged']->dataType);
        ...
        $this->assertEquals('varchar', $columns['cVCharNew']->dataType);
    ...
    public function testForeignKeyWhileCreation()
    {
        ...
        $table = new MetaTable(self::$childTable);
    ...
    public function testRemoveForeignKeyWIthNewColumn()
    {
        ...
        $this->assertEquals('varchar', $columns['newColumn']->dataType);
    ...
    public function testAddIndexKey()
    {
        ...
        $table = new MetaTable(self::$mainTable);
