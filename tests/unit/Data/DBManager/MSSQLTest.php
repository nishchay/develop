...
class MSSQLTest extends TestCase
{
     ...
     * @var string
     */
    private static $connectionName = 'mssql';
    ...
    public function testAlterTable()
    {
        $this->getDBManager()
                ->setTableName(self::$mainTable)
                ->setColumn(['cVChar' => 'cVChar'], ['VARCHAR' => 100], true)
                ->setColumn(['cDouble' => 'cDoubleChanged'], 'NUMERIC', true)
        ...
        $this->assertEquals(0, $columns['cDoubleChanged']->scale);
    ...
    public function testAddForeignKeyWithChangeColumn()
    {
        $this->getDBManager()
                ->setTableName(self::$childTable)
                ->setColumn(['foreignKey' => 'foreignKeyChanged'], 'bigint', true)
